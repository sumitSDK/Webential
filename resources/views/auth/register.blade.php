    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" name="register_form" id="register_form" action="{{ route('register') }}" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="phone-no" class="col-md-4 col-form-label text-md-end">{{ __('Phone Number') }}</label>

                            <div class="col-md-6">
                                <input id="phone-no" type="text" class="form-control" name="phone_no">
                                @error('phone_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        $("#register_form").validate({
            ...
            messages: {
                ...
                profile_pic: {
                    ...
                    extension: "Please select an jpg image only."
                }
            }
        });
    });
